import logging
import os, json, email, imaplib, ssl, socket, time
...
IMAP_SERVER = get_env("IMAP_SERVER", "imap.mailo.com")
IMAP_PORT = int(get_env("IMAP_PORT", 993))
MAILBOX_USER = get_env("MAILBOX_USER")
MAILBOX_PASS = get_env("MAILBOX_PASS")
MAILBOX_FOLDER = get_env("MAILBOX_FOLDER", "INBOX")
MATCH_CRITERIA = get_env("MATCH_CRITERIA", '(FROM "newsletter@substack.com" UNSEEN)')
